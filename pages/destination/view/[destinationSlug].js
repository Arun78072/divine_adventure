      ...
      <DestinationStyle>
        ...
        <div className="container view_section">
          <div className="left_section">
            ...
            <p className="price">
              <LuIndianRupee />
              <span>{postData?.tourInfo?.price}</span> <span>/ Per Couple</span>
            </p>
            <Image
              src={postData?.tourInfo?.coverImage}
              width={0}
            ...
            <div className="gallery_section">
              ...
              <p>
                Discover the unforgettable highlights of this tour through our
                curated photo gallery. From scenic landscapes and vibrant local
                experiences to cultural landmarks and fun-filled activities,
                each snapshot captures the essence of your journey. Let the
                pictures tell the story before you even begin your adventure.
              </p>
